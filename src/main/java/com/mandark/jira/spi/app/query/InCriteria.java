...
/**
 * A {@link PropertyCriteria} criteria to match the Data Property value with any one of the passed
 * values.
 */
public class InCriteria extends PropertyCriteria<Collection<?>> {
    ...
    InCriteria(String property, Collection<?> values) {
        ...
        assert Objects.nonNull(values) && !values.isEmpty() : "InCriteria :: Values Collection is EMPTY";
    }
